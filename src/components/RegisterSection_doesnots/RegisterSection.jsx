...
function RegisterSection() {
  return (
    <div className="p-6">
      <div
        className="flex items-center justify-center rounded-xl sm:px-8 md:px-16 sm:m-4 md:m-16"
        style={{
      ...
      >
        ...
        <div className="absolute top-4 sm:top-8 md:top-16 left-0 right-0 flex flex-col items-center justify-center p-16 sm:p-8 md:p-16 text-[#E0E2FF] gap-1">
          <h2 className="text-3xl font-medium sm:text-3xl md:text-5xl font-spline sm:mt-10">
            {"Find out about"}
            <br />
            {"Hacktober Fest"}
          </h2>
